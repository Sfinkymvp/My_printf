...
my_printf:
    ...
    push    r9                          ; 5-й аргумент
    push    r8                          ; 4-й аргумент
    push    rcx                         ; 3-й аргумент
    push    rdx                         ; 2-й аргумент
    push    rsi                         ; 1-й аргумент
    push    rdi                         ; Форматная строка)
...
; Входные параметры:
;       [bp + 24] (Ptr)   - Форматная строка
;       [bp + 24 + 8 * i] - Данные для i-го аргумента
; Выходные параметры:
;       Нет
; Портящиеся регистры:
;       callee-caller
